...
def main():
  ...
  pickle.dump(ifttt_train, open('ifttt_class.pkl', 'w'))
  ...
  with tf.Session() as sess:
    ...
    item = all_probs[0]
    print data['labelers']['trigger_chans'].inverse_transform([item[0]])
    print data['labelers']['trigger_funcs'].inverse_transform([item[1]])
    print data['labelers']['action_chans'].inverse_transform([item[2]])
    print data['labelers']['action_funcs'].inverse_transform([item[3]])
